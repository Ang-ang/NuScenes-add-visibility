...
std::tuple<Eigen::VectorXf, Eigen::VectorXb, Eigen::VectorXb> _compute_visibility_and_masks_no_timestamp(
        const Eigen::MatrixXf & original_points,
        const Eigen::MatrixXf & sampled_points,
        const Eigen::RowVector3f & sensor_origins,
        //const Eigen::VectorXf & time_stamps,
...
Eigen::VectorXf _compute_visibility_no_timestamp(const Eigen::MatrixXf & original_points,
                                 const Eigen::RowVector3f & sensor_origins,
                                 //const Eigen::VectorXf & time_stamps,
                                 const Eigen::VectorXf & pc_range,
                                 const double voxel_size,
...
std::tuple<Eigen::VectorXf, Eigen::VectorXb, Eigen::VectorXb> _compute_logodds_and_masks_nuscenes(
    const Eigen::MatrixXf & original_points,
    const Eigen::MatrixXf & sampled_points,
    const Eigen::RowVector3f & sensor_origins,//change MatrixXf to RowVector3f
    const Eigen::VectorXf & time_stamps,
    const Eigen::VectorXf & pc_range,
    const double voxel_size,
    const double lo_occupied,
    ...
    const bool culling_sampled)
{
    ...
    for (int t = 0; t < T; ++ t) {
        // set up update variable and sensor origin
        Eigen::VectorXf update = Eigen::VectorXf::Zero(G3);
        Eigen::Vector3d origin = (sensor_origins - offset3d).cast<double>();//change sensor_origins.row(t) to sensor_origins
...
PYBIND11_MODULE(mapping, m) {
    ...
    m.def("compute_visibility_and_masks_no_timestamp",
          &_compute_visibility_and_masks_no_timestamp,
          py::arg("original_points"),
          py::arg("sampled_points"),
          py::arg("sensor_origins"),
          //py::arg("time_stamps"),
          py::arg("pc_range"),
          py::arg("voxel_size"),
          py::arg("lo_occupied")=1,
          py::arg("lo_free")=-1,
          py::arg("culling_original")=true,
          py::arg("culling_sampled")=false
          );

    m.def("compute_visibility_no_timestamp",
          &_compute_visibility_no_timestamp,
          py::arg("original_points"),
          py::arg("sensor_origins"),
          //py::arg("time_stamps"),
          py::arg("pc_range"),
    ...
    m.def("compute_logodds_and_masks_nuscenes",
          &_compute_logodds_and_masks_nuscenes,
          py::arg("original_points"),
          py::arg("sampled_points"),
          py::arg("sensor_origins"),
          py::arg("time_stamps"),
